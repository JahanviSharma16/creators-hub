      ...
      <section className="relative h-96 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto">
            Learn from talented creators and unlock your potential
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className={`text-lg ${isDarkMode ? 'text-gray-300' : 'text-gray-600'} max-w-2xl mx-auto`}>
              Meet the talented creators behind amazing content
            </p>
          </div>
              ...
              >
                ...
                <div className="p-6 -mt-12 relative">
                  ...
                  <div className="flex space-x-3 mb-4">
                    {creator.socialLinks.website && (
                      <a 
                        ...
                        className={`p-2 rounded-lg ${isDarkMode ? 'bg-gray-600 hover:bg-gray-500' : 'bg-gray-200 hover:bg-gray-300'} transition-colors`}
                      >
                  ...
                  <Link 
                    ...
                    className="block w-full text-center bg-gradient-to-r from-purple-500 to-pink-500 text-white py-2 rounded-lg hover:from-purple-600 hover:to-pink-600 transition-colors"
                  >
                    View Profile
                  </Link>
                </div>
          ...
          <div className="text-center mt-8">
            <Link 
              to="/creators"
              className="inline-flex items-center text-purple-500 hover:text-purple-600 font-semibold"
            >
              View All Creators
      ...
      <section className={`py-16 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className={`text-lg ${isDarkMode ? 'text-gray-300' : 'text-gray-600'} max-w-2xl mx-auto`}>
              Discover the most popular and highly-rated content from our creators
            </p>
          </div>
